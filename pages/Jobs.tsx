        ...
        <div className="grid grid-cols-1 gap-6">
          {filteredJobs.length > 0 ? (
            filteredJobs.map(job => (
              <div key={job.id} className="bg-white rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all border border-stone-100 p-8 md:p-10 flex flex-col md:flex-row justify-between items-start md:items-center group">
                ...
                <div className="mt-8 md:mt-0 md:ml-8 flex flex-col items-end space-y-3">
                  ...
                  <Link to={`/business/${job.business.id}`} className="px-8 py-4 bg-sky-900 text-white font-black rounded-2xl shadow-lg hover:bg-sky-800 transition-all active:scale-95 whitespace-nowrap">
                    Apply Now
                  </Link>
                </div>
              </div>
