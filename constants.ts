...
export const MOCK_BUSINESSES: Business[] = [
  {
    ...
    jobs: [
      { id: 'j1', title: 'Surf Instructor', description: 'Experienced surfer needed for seasonal weekend clinics. Must be CPR certified.', type: JobType.PART_TIME, salary: '$25/hr', postedAt: '2025-05-01' },
      { id: 'j2', title: 'Retail Associate', description: 'Passionate about surf culture? Join our retail team in Dana Point.', type: JobType.FULL_TIME, salary: '$18-20/hr', postedAt: '2025-05-05' }
    ]
  },
  {
    id: '2',
    ...
    jobs: [
      { id: 'j3', title: 'Sous Chef', description: 'Seeking a creative sous chef with experience in Pacific fusion seafood.', type: JobType.FULL_TIME, salary: '$65k-75k', postedAt: '2025-05-10' }
    ]
  },
  {
    id: '3',
    ...
    reviewCount: 89,
    jobs: [
      { id: 'j4', title: 'Community Manager', description: 'Oversee daily operations and member engagement for our tech-focused community.', type: JobType.FULL_TIME, salary: '$55k-65k', postedAt: '2025-05-08' }
    ]
  },
  {
    id: '5',
    ...
    jobs: [
      { id: 'j5', title: 'Taproom Server', description: 'Beer enthusiasts wanted for our busy Anaheim taproom. Must be 21+.', type: JobType.PART_TIME, salary: '$16/hr + tips', postedAt: '2025-05-12' }
    ]
  },
  {
    id: '9',
